...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::linker::migrate_agent_skill_to_central,
            commands::linker::batch_migrate_agent_skills_to_central,
            // Skills
            ...
            commands::central_repository::get_central_repository_config,
            commands::central_repository::set_central_repository_config,
            commands::central_repository::get_central_repository_status,
            commands::central_repository::initialize_central_repository,
            commands::central_repository::pull_central_repository,
            commands::central_repository::push_central_repository,
            // Discover
